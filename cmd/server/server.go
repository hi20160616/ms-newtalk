...
import (
	...
	"github.com/hi20160616/ms-newtalk/internal/job"
	"github.com/hi20160616/ms-newtalk/internal/server"
...
func main() {
	...
	// Job
	g.Go(func() error {
		log.Printf("[%s] Job is working", configs.Data.MS["newtalk"].Title)
